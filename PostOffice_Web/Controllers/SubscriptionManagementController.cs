...
public class SubscriptionManagementController(PostOfficeContext postOfficeContext) : Controller
{
	[Authorize(Roles = "PostalOperator,Director")]
	public IActionResult Main() => View("Main", postOfficeContext.Subscriptions.ToList());
	...
	public async Task<IActionResult> Approve(int id)
	{
		...
		return View("Main", postOfficeContext.Subscriptions.ToList());
	}
